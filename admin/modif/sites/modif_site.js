...
function displaySites(sites) {
    ...
    sites.forEach(site => {
        ...
        card.className = 'card';
        card.style.backgroundImage = `url('/image/${site.ville}.png')`;
        ...
        card.innerHTML = `
            <div class="footer">
                ...
                <div class="info">
                    <div class="ville">${site.ville}</div>
                    <div class="type">${site.type}</div>
                    <a href="form_site.html?id=${site.id}"><button id="button_modif">Modfier</button></a>
                </div>
            </div>
